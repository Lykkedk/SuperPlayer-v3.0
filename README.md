...
The samplerate detection is a hackup UP squeezelite player, which i did with some help from my older son ;-)... This way is deprecated now, and there\
are other way's of doing this which work's much better!...
